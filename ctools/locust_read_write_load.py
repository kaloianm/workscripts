...
Example usage:
  ...
  locust -f locust_read_write_load.py --processes 4 --users 1000 --spawn-rate 100 --autostart \\
      --web-port 8090 \\
      --mgodatagen-config locust_read_write_load_mgodatagen_50GB.json \\
      --host mongodb://URL/?directConnection=false
'''
